/**
 * 系统提示词库聚合服务：抓取多个 GitHub 提示词仓库并缓存 1 小时。
 * 同时被 vite dev 中间件与生产 node server 使用（同源 GET /api/prompts）。
 */
...
export async function promptListPayload(params: URLSearchParams): Promise<PromptListPayload> {
