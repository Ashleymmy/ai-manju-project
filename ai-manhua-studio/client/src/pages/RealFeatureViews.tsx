  ...
  return <div className="feature-page profile-page">
    ...
    <div className="profile-workspace">
      <section className="profile-account-section">
        ...
        <p className="profile-role-text">{user?.role}</p>
      </section>
      <div className="profile-stats-row">
        <div className="profile-metric-card">
          <span className="metric-label">进行中项目</span>
          <b className="metric-value">{data.projects.total ?? "—"}</b>
          <small className="metric-unit">前进中现活跃项目</small>
        </div>
        <div className="profile-metric-card">
          <span className="metric-label">资产管理</span>
          <b className="metric-value">{data.assets.total ?? "—"}</b>
          <small className="metric-unit">图企中现活资产</small>
        </div>
        <div className="profile-metric-card">
          <span className="metric-label">可视推进</span>
          <b className="metric-value">{data.jobs.total ?? "—"}</b>
          <small className="metric-unit">并用线程和进站</small>
        </div>
        <div className="profile-metric-card">
          <span className="metric-label">资配预设</span>
          <b className="metric-value">{promptCount < 10 ? `0${promptCount}` : promptCount}</b>
          <small className="metric-unit">提供配额预设项</small>
        </div>
      </div>
