...
const primaryRoutes: AppRoute[] = [
  ...
  defineAppRoute({ id: "canvas-project", path: "/canvas/:id", loader: () => import("@/features/canvas"), permission: "authenticated", layout: "canvas" }),
  defineAppRoute({ id: "canvas", path: "/canvas", loader: () => import("@/features/canvas"), permission: "authenticated", layout: "canvas" }),
