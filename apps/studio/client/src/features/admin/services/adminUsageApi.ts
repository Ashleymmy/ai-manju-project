...
export type UsageRow = { job_id: string; user_id: string; username: string; display_name: string; project_id: string; project_name: string; workspace_id: string; internal: boolean; task_type: string; model: string; provider: string; status: string; credit_status: string; credits_quoted: number; credits_settled: number; created_at: string; started_at: string | null; finished_at: string | null; settled_at: string | null; attempts: number; estimated_cost_micros: number | null; actual_cost_micros: number | null; cost_reference: string; rate_id: string; cost_unit: string; cost_quantity: number; resolution: string; duration_seconds: number; output_count: number };
