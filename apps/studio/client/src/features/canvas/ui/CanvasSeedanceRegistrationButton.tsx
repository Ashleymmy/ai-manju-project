import { BadgeCheck, Check, Clock3, Loader2, RotateCcw } from "lucide-react";
...
export function CanvasSeedanceRegistrationButton({ node, state, onRegister, className = "", showLabel = false, disabled = false }: {
  ...
  const Icon = busy ? Loader2 : phase === "success" ? Check : phase === "pending" ? Clock3 : phase === "error" ? RotateCcw : BadgeCheck;
  return <button
    type="button"
