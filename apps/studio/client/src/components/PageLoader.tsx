...
export default function PageLoader({ label = "正在加载…", contained = false }: { label?: string; contained?: boolean }) {
  return (
    <div className={`page-loader${contained ? " page-loader-contained" : ""}`} role="status" aria-label={label}>
      <img
