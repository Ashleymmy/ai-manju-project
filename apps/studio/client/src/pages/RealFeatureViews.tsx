...
import { createSkillEntry, exportSkillsFile, importSkillsFile, loadSkills, persistSkills, type CanvasSkill } from "@/lib/skill-library";
...
/** 技能库页面：与画布节点「提示词优化」菜单共用 localStorage 中的 skill 数据，
    这里的新建/编辑/启停会直接反映到画布节点选择技能时的列表。 */
